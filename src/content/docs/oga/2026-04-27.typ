...
#metadata((
  description: "Le prospettive Garvin sulla qualità, dimensioni misurabili, standard ISO 9001, costi di prevenzione e guasto, controllo statistico e total quality management.",
  lang: "it",
...
di processo per distinguere *variabilità casuale* (accettabile) da *variabilità
da cause speciali* che richiede un intervento.
