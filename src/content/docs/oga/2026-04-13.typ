...
#metadata((
  description: "Fallimento dei nuovi prodotti, ciclo di vita, modello stage-gate per la progettazione, tecniche QFD e FMEA per valutazione, analisi FAST e distinta base BOM.",
  lang: "it",
...
- *package*: insieme dei prodotti e servizi che provvedono al raggiungimento dei
  benefici attesi. Definizione dei componenti core e supporting;
...
+ *Ideazione del concept*: si prendono idee da R&D, competitors, clienti,
  ricerche di mercato, staff e si definiscono funzioni, forma, benefici e scopo
  del nuovo prodotto.

+ *Screening*: studio di fattibilità, accettabilità, vulnerabilità.

+ *Progettazione preliminare*: si definiscono prodotti e servizi che
  costituiranno il package e processi a supporto della creazione del package.

  Le distinte base (Bills of Materials) evidenziano le quantità di materie prime
  richieste per ogni componente.

+ *Valutazione e miglioramento*: dagli output della progettazione preliminare si
  effettua la valutazione delle alternative, in modo da effettuare miglioramenti
  prima del lancio.

  Tecniche comunemente utilizzate sono:

  - *Quality Function Deployment (QFD)*: traduce i desideri del cliente (what)
    nelle specifiche tecniche del prodotto (how).
  - *Failure Mode and Effects Analysis (FMEA)*: analizza i potenziali guasti di
    un prodotto: come si rompe, perché si rompe e quali conseguenze ha la
    rottura.
  - *Analisi del Valore*: analizza il rapporto tra soddisfazione della funzione
    e risorse utilizzate.

+ *Prototipazione e progettazione finale*;
