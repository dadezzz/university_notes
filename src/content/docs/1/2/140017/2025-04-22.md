...
$f: Q \to \R$ limitata, ovvero tale che $\sup_Q f$ esista.
...
della retta reale $\Set{x_0, \ldots, x_m}$ tale che $a = x_0 < \dots < x_m = b$.

Analogamente, si definisce suddivisione dell'intervallo $[c, d]$ un insieme
finito di punti $\Set{y_0, \ldots, y_n}$ tale che $c = y_0 < \dots < y_n = d$.

Una suddivisione di $Q$ in $\R^2$ è definita dalla coppia $(D_1, D_2)$, dove
...
(che vale 1 sui razionali e 0 sugli irrazionali), la quale ha infiniti punti di
discontinuità e il cui insieme di discontinuità ha misura non nulla.
