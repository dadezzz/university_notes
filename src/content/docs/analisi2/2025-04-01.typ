...
limitato e chiuso, e che $f$ sia continua su $A$. Allora esistono $max_A f$ e
$min_A f$.
...
- $bold(x)^* in dot(A)$ e $nabla f(bold(x)^*) = bold(0)$, allora si ricade nei
  casi trattati nella lezione precedente (punti stazionari interni).
- $bold(x)^* in dot(A)$ ma $nabla f(bold(x)^*)$ non esiste, allora $bold(x)^*$ è
  definito punto singolare e richiede un'analisi diretta.
