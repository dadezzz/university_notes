...
- $x_1(t) = A_1 op("rect")(t / T)$
- $x_2(t) = A_2 op("rect")(t / T)$
...
calcolare l'intervallo $abs(t) < T$.
...
- per $t < - (T_1 + T_2) / 2$ e $t > (T_1 + T_2) / 2$ i rettangoli non si
  incontrano;
- in $- (T_1 + T_2) / 2 < t < (T_1 - T_2) / 2$ avremo una rampa crescente;
- in $(T_1 - T_2) / 2 < t < (T_2 - T_1) / 2$ avremo una fase piatta con valore
  $A_1 A_2 T_1$;
- in $(T_2 - T_1) / 2 < t < (T_1 + T_2) / 2$ avremo una rampa decrescente;
...
- $x_1(t) = 1 / sqrt(2 pi sigma_1^2) e^(- (t - mu_1)^2 / (2 sigma_1^2))$
- $x_2(t) = 1 / sqrt(2 pi sigma_2^2) e^(- (t - mu_2)^2 / (2 sigma_2^2))$
