...
La normalizzazione $1 / K$ serve per evitare di alterare il valor medio del
segnale in ingresso.
...
- filtro a gradino: $h[k] = mat(delim: "[", -1, 1)$, esegue una derivata prima
  discreta del segnale.
