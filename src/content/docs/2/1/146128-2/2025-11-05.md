...
$$
H(f) = \operatorname{rect}\left(\frac{f}{2 f_2}\right)
$$
...
$$
y(t) = 2 f_2 x(t) * \operatorname{sinc}(2 f_2 t)
$$
...
$$
H(f) = 1 - \operatorname{rect}\left(\frac{f}{2 f_1}\right)
$$
...
$$
y(t) = x(t) - 2 f_1 x(t) * \operatorname{sinc}(2 f_1 t)
$$
...
$$
H(f) = \operatorname{rect}\left(\frac{f}{2 f_2}\right) - \operatorname{rect}\left(\frac{f}{2 f_1}\right)
$$
...
$$
y(t) = 2 x(t) * (f_2 \operatorname{sinc}(2 f_2 t) - f_1 \operatorname{sinc}(2 f_1 t))
$$
