...
$$
X_k = \begin{cases}
\frac{a_k}{2} e^{j\vartheta_k} & k > 0 \\
\frac{a_{-k}}{2} e^{-j\vartheta_{-k}} & k < 0 \\
a_0 & k = 0
\end{cases}
$$
...
$$
X_k = f_0 \int_{-\frac{T_0}{2}}^{\frac{T_0}{2}} x(t)\ e^{-j2\pi k f_0 t}\,dt
$$

La formula equivale alla cross-correlazione tra il segnale $x(t)$ e la sinusoide
$e^{-j2\pi k f_0 t}$ sul periodo $T_0$ (entrambi i segnali sono periodici e
...
alternativa: $x(t) \leftrightarrow X_k$.
...
- Dato un segnale periodico pari, i coefficienti saranno reali, per cui la serie
  ...
  $$
  X_k = 2\,f_0 \int_0^{\frac{T_0}{2}} x(t)\ \cos(2\pi k f_0 t)\,dt
  $$

  $$
  x(t) = a_0 + \sum_{k = 1}^{+\infty} a_k \cos(2\pi k f_0 t)
  $$
...
- Dato un segnale periodico dispari, i coefficienti saranno immaginari, per cui
  ...
  $$
  X_k = -2\,j\,f_0 \int_0^{\frac{T_0}{2}} x(t)\ \sin(2\pi k f_0 t)\,dt
  $$
