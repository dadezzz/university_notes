...
Convenzionalmente si dà precedenza all'operazione $\text{AND}$ rispetto alla
...
dato che ogni porta logica impiega un breve periodo di tempo per eseguire la
propria operazione.
...
- **proprietà associativa**:
  ...
  Permette di definire in modo univoco le operazioni $\text{AND}$ ed $\text{OR}$
  con più di 2 variabili.
