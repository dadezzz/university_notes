...
1. Mentre la wordline è ancora disattivata, la bitline è precaricata a
   $\frac{V_{DD}}{2}$ per rendere più veloce la lettura.
...
Una piccola variazione da $\frac{V_{DD}}{2}$ (punto di lavoro instabile) fa sì
che il circuito si porti verso lo 0 o 1 logico.

I transistor in basso sono quelli che impongono inizialmente la tensione
$\frac{V_{DD}}{2}$ e contemporaneamente caricano le bitline. I valori
memorizzati generano poi una piccola variazione che porta il sense amplifier a 0
o 1.
