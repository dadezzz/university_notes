...
arriva al più a $V_{DD} - V_{TN}$) perchè il canale svanisce. La situazione è
anche peggiorata dall'effetto body ($V_{SB} \neq 0$).
...
di stato del CMOS, ma nel caso in cui il pull-down è aperto, la carica della
