...
la resistenza a 0, e quindi $1 / R = +oo$. Questo significa che un generatore di
tensione con $V = 0$ è equivalente a un resistore con $R = 0$, ovvero un
cortocircuito.

Eseguendo l'operazione contraria, ovvero portando la resistenza a $+oo$, si può
simulare un generatore di corrente spento. Questo dimostra che un generatore di
...
so che $V = V_R_1 + V_R_2 = I (R_1 + R_2)$:
