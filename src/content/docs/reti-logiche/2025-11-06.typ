...
#metadata((
  description: "Separazione del sistema RTL tra data path per il trattamento dati e unità di controllo come macchina a stati, con ALU come componente hardware condiviso.",
  lang: "it",
  next: false,
...
*unità di controllo* la parte che si occupa di gestire le operazioni secondo un
flusso logico.
