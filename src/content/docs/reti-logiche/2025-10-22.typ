...
#metadata((
  description: "Diagrammi degli stati, codifica, analisi dei tempi di setup e hold, macchine di Mealy e Moore, progetto di circuiti sequenziali e diagrammi temporali.",
  lang: "it",
...
+ deriviamo l'espressione dello stato futuro (in funzione degli ingressi primari
  e dello stato presente);
+ deriviamo l'espressione delle uscite;
...
+ Progetto del diagramma degli stati;
+ Derivazione della tabella della verità degli stati;
+ Per ogni uscita o variabile di stato futuro semplifichiamo la rispettiva mappa
  di Karnaugh;
+ Dai risultati della semplificazione si ottiene l'espressione logica da usare;
+ Si crea il circuito con le porte date dall'espressione logica;
