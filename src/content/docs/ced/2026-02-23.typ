...
$E = 1 / (4 pi epsilon_0) abs(q) / r^2$, dove $r$ è la distanza da $q$. La forza
esercitata da $E$ su una carica $Q$ è data da: $arrow(F) = Q arrow(E)$.
...
$P = v(t) thin i(t) = R i^2$.

Se disegnassimo un grafico su un piano con assi $i$ (ascisse) e $v$ (ordinate),
il rapporto $v / i$ rappresenterebbe una retta con pendenza $R$.
