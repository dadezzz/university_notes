...
L'energia fornita è $E_D = integral_0^(+oo) P(t) dif t$, dove
$P(t) = V_"DD" i(t)$. La corrente è quella che scorre nel condensatore
$i(t) = C (dif V_C(t)) / (dif t)$.

Integrando, risulta che l'energia fornita $E_D$ è $C V_"DD"^2$, quella
immagazzinata nel condensatore $E_S$ è $1 / 2 C V_"DD"^2$. L'energia dissipata è
quindi $E_L = E_D - E_S = 1 / 2 C V_"DD"^2$.
