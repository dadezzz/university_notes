...
Quando l'ingresso è a $V_+$, l'uscita va a $V_"L"$. Viceversa, quando l'ingresso
...
- $V_"OL"$: è la tensione di uscita per $V_"I" = V_"IH"$;
- $V_"OH"$: è la tensione di uscita per $V_"I" = V_"IL"$;
...
Il margine di rumore è definito come la differenza $"NM"_"H" = V_"OH" - V_"IH"$
...
limitare la corrente che passa quando l'uscita è bassa.
