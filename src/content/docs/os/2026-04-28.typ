...
#metadata((
  description: "Port mapped and memory mapped I/O register mapping, polling and interrupt strategies, direct memory access, and vectored I/O for efficient device communication.",
  lang: "en",
...
- *Nonblocking*: the CPU initiates the I/O operation but does not wait for it to
  complete. The OS may return immediately with a partial result or an indication
