...
#metadata((
  description: "Protection domains, hardware rings, access matrix implementations, and Linux security mechanisms including capabilities, seccomp filtering, and code signing.",
  lang: "en",
